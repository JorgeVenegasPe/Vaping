        ...
        <div style="display: flex; flex-direction:row; align-items:center">
            <div class="container-icons">
                <div class="icons">
                    ...
                    <a href="#" class="a"><?=ucfirst($_SESSION['Nombre'])?>
                        <a id="perfilBtn" class="perfil"><span
                                class="material-symbols-sharp ii ajuste ">person</span></a>
                        <a href="../Crud/cerrar-sesion.php"><span class="material-symbols-sharp ii ajuste ">logout</span></a>
