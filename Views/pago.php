                ...
                <div class="inputs-selects">
			    	<select style="text-align: center" class="input" id="Distrito" name="Distrito" required>
                        ...
                        <?php foreach ($distritos as $distrito) : ?>
                            <option value="<?php echo $distrito['IdDistrito']; ?>" data-id="<?php echo $distrito['IdDistrito']; ?>"><?php echo $distrito['Distrito']; ?></option>
                        <?php endforeach; ?>
                    </select>
			    </div>
                <br>
...
<div class="service-modal modal-yape flex-center" >
    <div class="service-modal-body">
        ...
        <div class="container-butt">
            <button class="button-T" id="openNuevoModalBtn">
...
<div class="service-modal modal-visa flex-center" >
    <div class="service-modal-body">
        ...
        <div class="container-butt">
            <button class="button-T" id="openNuevoModalBtn2">
                <p class="text">Listo</p>
            </button>
        </div>
    </div>
...
<div class="service-modal modal-plin flex-center" >
    <div class="service-modal-body">
        ...
        <div class="container-butt">
            <button class="button-T" id="openNuevoModalBtn3">
                <p class="text">Listo</p>
            </button>
        </div>
    </div>
...
<div class="service-modal modalformrt flex-center" id="nuevoModal">
    <div class="service-modal-body">
        <i class="fas fa-times modal-close-btn"></i>
        <form class="FormSeleccionTienda">
			<div class="box-input2">
				<h1 style="text-align: center;">Subir comprobante de pago</h1>
                <br>
            ...
            <!-- AQUI Hice un cambio en los botones-->
            <div class="container-butt">
                <button class="button-T" id="enviarBtn">
                    <i class="ri-arrow-left-line"></i>
                    <p class="text">Enviar </p>
                </button>
                <button class="button-T datos" id="cancelarBtn">
                    <p class="text finalcomp">Cancelar</p>
                    <i class="ri-arrow-right-line"></i>
                </button>
            </div>
        </form>
...
const modalCloseBtnsModal = document.querySelectorAll(".modal-close-btnmodal");
    ...
    const openNuevoModalBtn = document.getElementById("openNuevoModalBtn"); //ID de la opcion yape , comprobante de pago
    const openNuevoModalBtn2 = document.getElementById("openNuevoModalBtn2"); //ID de la opcion visa, comprobante de pago
    const openNuevoModalBtn3 = document.getElementById("openNuevoModalBtn3"); // ID de la opcion plin, comprobante de pago
    ...
    const nuevoModal = document.getElementById("nuevoModal"); // ID del modal comprobante de pago 
    ...
    openNuevoModalBtn.addEventListener("click", function() {
    nuevoModal.classList.add("active"); // Abre el nuevo modal, comprobante de pago
    
});
    openNuevoModalBtn2.addEventListener("click", function() {
    nuevoModal.classList.add("active"); // Abre el nuevo modal, comprobante de pago
    
});
    openNuevoModalBtn3.addEventListener("click", function() {
    nuevoModal.classList.add("active"); // Abre el nuevo modal, comprobante de pago
...
//Supuesta funcion para los botones enviar y cancelar del modal Comprobante de pago, falta arreglar esto
const enviarBtn = document.getElementById("enviarBtn");
const cancelarBtn = document.getElementById("cancelarBtn");

enviarBtn.addEventListener("click", function() {
    // Agrega la lógica para enviar el formulario
    nuevoModal.classList.remove("active"); // Cierra el nuevo modal
});
...
//Funcion para que carguen las imagenes del modal Comprobante de pago
function cargarImagenEnModal() {
    ...
    fileInput.addEventListener("change", function (e) {
        ...
        reader.onload = function () {
            ...
            preview.innerHTML = ""; // Limpia el contenido anterior
...
openNuevoModalBtn.addEventListener("click", function () {
    nuevoModal.classList.add("active"); // Abre el nuevo modal
    cargarImagenEnModal();
});
