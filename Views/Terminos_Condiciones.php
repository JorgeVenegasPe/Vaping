      ...
      <div class="Terminos">
        ...
        <div class="conta">
          ...
          <div class="itemTer">
              ...
              <div class="conteTer" id="content1">
              Vaping Cloud a través de su sitio web concede una licencia para que los usuarios utilicen los productos 
              que son vendidos en este sitio web de acuerdo a los Términos y Condiciones que se describen en este documento.
              </div>
          </div>
          <div class="itemTer">
              <div class="head" id="head1">
              ...
              <div class="conteTer" id="content1">
              No está permitido colocar ninguno de nuestros productos, modificado o sin modificar, en un CD, 
              sitio web o cualquier otro medio para redistribución o reventa sin previa autorización por escrito.
              </div>
          </div>
          <div class="itemTer">
              <div class="head" id="head1">
              ...
              <div class="conteTer" id="content1">
              Los productos ofrecidos en esta tienda en línea son propiedad exclusiva de Vaping Cloud, la entidad que opera 
              y gestiona este sitio web. Todos los derechos de propiedad intelectual, incluidos, entre otros, los derechos de autor, 
              marcas registradas y diseños, asociados con los productos, pertenecen a Vaping Cloud. La reproducción, distribución o 
              modificación de los productos, ya sea total o parcialmente, sin la autorización expresa por escrito de 
              Vaping Cloud, está estrictamente prohibida.
              </div>
          </div>
          ...
          <div class="itemTer">
              ...
              <div class="conteTer" id="content1">
              Estos Términos y Condiciones entrarán en vigencia a partir del [Fecha de entrada en vigencia].
              </div>
          </div>    
          <div class="itemTer">
              <div class="head" id="head1">
